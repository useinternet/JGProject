...
namespace GR
{
	namespace Dx12
	{
		...
		enum EG_Common_RootParam
		{
			...
			G_Common_RootParam_LightCB,
			G_Common_RootParam_PassCB,
			G_Common_RootParam_Texture,
			G_Common_RootParam_CubeTexture,
			G_Common_RootParam_NumRootParam
		};
		enum EG_ShadowMapping_RootParam
		{
			G_ShadowMapping_RootParam_DepthTexture = 0,
			G_ShadowMapping_RootParam_LightDepthTexture,
			G_ShadowMapping_RootParam_LightDepthCubeTexture,
			G_ShadowMapping_RootParam_LightPassCB,
			G_ShadowMapping_RootParam_LightCB,
			G_ShadowMapping_RootParam_ShadowMappingCB,
			G_ShadowMapping_RootParam_NumRootParam
		};
