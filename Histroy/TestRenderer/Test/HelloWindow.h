...
#include"GpuApi/DirectX12/Light.h"
#include"GpuApi/DirectX12/ShadowMapping.h"
...
public:
	...
	GPUAllocation m_LightShadowGPU;
private:
	...
	std::string m_CurrentLight = "DirectionalLight";
...
public:
	...
	void UI();
private:
	ObjectCB UpdateObjectCB(float x = 0, float y = 0, float z = 0, bool rotate = true);
