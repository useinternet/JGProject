...
void AttackBaseComponent::Attack(const JGVector2D& Location, const float IsRight)
{
	bEnableAttack = false;
}
void AttackBaseComponent::Attack(const float x, const float y, const float IsRight)
{
