...
class JGUIRenderer;
class JGUICanvas;
class JGUIShape : public JGUIElement
{
...
public:
	...
	virtual void SetParent(JGUIElement* parent) override;
...
protected:
	...
	JGUIRenderer* GetRenderItem() const {
		return m_Renderer;
	}
private:
	void FindCanvas();
private:
	// 요기까지
	JGUIRenderer* m_Renderer    = nullptr;
...
class JGUIWindowTexture : public JGUIElement
{
protected:
	virtual void Awake() override;
public:
...
protected:
	...
	class JGUIWindowRenderer* m_Renderer;
};


class JGUIImage : public JGUIElement
{
...
private:
	...
	class JGUIImageRenderer* m_Renderer;
};
