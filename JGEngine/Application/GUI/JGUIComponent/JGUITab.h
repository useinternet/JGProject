...
//	void ReAdjustTabBtPos(JGUITabButton* pressed_tab_bt);
//	void ReAdjustTabBtPos(JGUIWindow* except_win);
//	void ReAdjustTabBtColor(JGUITabButton* except_bt, EJGUIBtState state, const JColor& color);
//	int  GetTabIndex(JGUIWindow* win);
//	int  GetTabIndex(JGUITabButton* bt);
//	void Connect(JGUIWindow* win);
//private:
//	struct TabInfo
//	{
