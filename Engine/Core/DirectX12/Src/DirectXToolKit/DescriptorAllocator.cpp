...
DescriptorAllocator::DescriptorAllocator(D3D12_DESCRIPTOR_HEAP_TYPE type, uint32_t numDescriptorPerHeap) :
	m_HeapType(type),
...
{
	auto newPage = make_shared<DescriptorAllocatorPage>(m_HeapType, m_NumDescriptorsPerHeap);
