...
namespace Dx12
{
	...
	private:
		...
		float m_Near;
		//
		Common::Rotator m_CameraRotator;
	...
	public:
		...
		const Common::JMatrix4x4& GetViewMatrix() const;
		const Common::JMatrix4x4& GetProjMatrix() const;
		Common::JMatrix4x4 GetHlslMatrix() const;
		Common::JMatrix4x4 GetHlslViewMatrix() const;
		Common::JMatrix4x4 GetHlslProjMatrix() const;
