...
#include "Zep/zep/mcommon/file/path.h"
#include "Zep/zep/mcommon/string/stringutils.h"
#include "Zep/zep/mcommon/logger.h"
#include "Zep/zep/mcommon/signals.h"

#include "Zep/zep/glyph_iterator.h"

#include "Zep/zep/editor.h"
#include "Zep/zep/line_widgets.h"
#include "Zep/zep/range_markers.h"
...
inline int ToASCII(const char ch)
{
    ...
    ret = std::min<unsigned int>(ret, 127u);
    return ret;
}
