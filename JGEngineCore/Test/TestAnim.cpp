...
TestAnim::TestAnim()
{
	...
	static JGConstructHelper::AnimationMesh2D IdleAnimationMesh(
		...
		EPivot::MiddleMiddle, 15, 5, 3, TT("../ManagementFiles/Resource/Breath.png"));
	...
	static JGConstructHelper::AnimationMesh2D LeftAnimationMesh(
		...
		EPivot::MiddleMiddle, 23, 5, 5, TT("../ManagementFiles/Resource/Water1.png"));
	...
	static JGConstructHelper::AnimationMesh2D UpAnimationMesh(
		...
		EPivot::MiddleMiddle, 19, 5, 4, TT("../ManagementFiles/Resource/Darkness1.png"));
	...
	static JGConstructHelper::AnimationMesh2D DownAnimationMesh(
		...
		EPivot::MiddleMiddle,26,5,6, TT("../ManagementFiles/Resource/Fire3.png"));
